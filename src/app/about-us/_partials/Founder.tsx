...
const Founder = ({image, name, specialty, qualifications, bio }: FounderProps) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div>
          <div
            ...
            className="bg-card border border-healthcare-secondary rounded-healthcare p-6 text-center shadow-healthcare"
          >
